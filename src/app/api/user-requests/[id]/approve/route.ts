// filename: src/app/api/user-requests/[id]/approve/route.ts
...
export async function POST(req: NextRequest, ctx: { params: { id: string } }) {
  ...
  try {
    ...
    console.error('[approve user request] error:', e)
    return NextResponse.json({ success: false, error: e?.message || 'Error intern' }, { status: 500 })
  }
}
